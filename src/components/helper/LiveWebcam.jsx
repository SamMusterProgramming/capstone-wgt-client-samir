            ...
            {recording ?
                     ...
                     <button id='stopCapture' onClick={handleStopRecording}
                      style={{position:"absolute", top:"0%",left:"1%"}}    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="26" height="30" fill="lightgreen" class="bi bi-record-btn-fill" viewBox="0 0 16 16">
                       ...
                       style={{position:"absolute", top:"40%",left:"50%",transform:"translate(-50%, 0%)"}}    >
                  ...
                  <button   onClick={handleFlipCamera}
                       style={{position:"absolute", top:"1%",left:"90%"}}    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="20" fill="white" className="bi bi-phone-flip" viewBox="0 0 16 16">
