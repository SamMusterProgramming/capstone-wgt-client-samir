        ...
        />
            ...
            {recording ?
                     ...
                     <button id='stopCapture' onClick={handleStopRecording}
                      style={{position:"absolute", top:"28%",left:"8%",transform:"translate(-50%, 0%)"}}    >
                        <svg xmlns="http://www.w3.org/2000/svg" width="46" height="46" fill="lightgreen" class="bi bi-record-btn-fill" viewBox="0 0 16 16">
                  ...
                  <button   onClick={handleFlipCamera}
                       style={{position:"absolute", top:"30%",left:"90%",transform:"translate(-50%, 0%)"}}    >
