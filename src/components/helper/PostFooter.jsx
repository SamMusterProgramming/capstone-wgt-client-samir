...
const PostFooter = (props) => {
  ...
  <div className='d-flex flex-row text-light justify-content-evenly gap-5 align-items-center  videofooter '>
    ...
    <div className='d-flex align-items-center gap-3'>
       ...
       <span style={{fontSize:'11px',color:'pink', fontWeight:'600', fontFamily:'Arsenal SC'}}>votes</span> 
       <span style={{fontSize:'11px',marginLeft:'0px'}}>{props.likesVotesData.vote_count}</span> 
       </div>   
    </div>
    <div className='d-flex align-items-center gap-3'>
       <button style={{color:'white',marginLeft:'15px'}} >
         <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" className="bi bi-chat-left-dots-fill" viewBox="0 0 16 16">
