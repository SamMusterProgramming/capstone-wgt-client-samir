  ...
  <div className='d-flex flex-row text-light justify-content-evenly gap-4 align-items-center videofooter'>
    ...
    <div className='d-flex align-items-center gap-3'>
       <button style={{color:props.isVotedColor,marginLeft:'15px'}} onClick={props.handleVotes} >
         <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" className="bi bi-heart-fill" viewBox="0 0 16 16">
           <path fillRule="evenodd" d="M8 1.314C12.438-3.248 23.534 4.735 8 15-7.534 4.736 3.562-3.248 8 1.314"/>
         </svg>
       </button>
       <div className='d-flex text-center gap-0 flex-column'>
       <span style={{fontSize:'11px',color:'pink', fontWeight:'600', fontFamily:'Arsenal SC'}}>vote</span> 
       <span style={{fontSize:'11px',marginLeft:'0px'}}>{props.likesVotesData.vote_count}</span> 
       </div>   
    </div>
    <div className='d-flex align-items-center gap-3'>
       <button style={{color:'white',marginLeft:'15px'}} >
         <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" fill="currentColor" className="bi bi-chat-left-dots-fill" viewBox="0 0 16 16">
    ...
    <div className='d-flex align-items-center gap-1'>
       <button style={{color:'pink',marginLeft:'15px'}} >
          <svg xmlns="http://www.w3.org/2000/svg" width="15" height="14" fill="currentColor" className="bi bi-share-fill" viewBox="0 0 16 16">
