...
const VideoRecorder = (props) => {  
  return (        
    <button  type='button' style={{backgroundColor:''}} onClick={(e)=>props.setSwitchUploadLive(prev => !prev)}>
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="red" className="bi bi-webcam-fill" viewBox="0 0 16 16">
