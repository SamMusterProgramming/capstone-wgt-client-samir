  ...
  return (
    <div className='d-flex flex-column align-items-center gap-3 justify-content-center'
        style=  {{ width:'100%',height:'100%'}}>
          ...
          <p style={{color:'black',fontSize:'12px'}}>bellow , a Demo Video to help you  familiarise yourself with the Challengify app </p> 
            <div className='d-flex flex-column align-items-center  justify-content-center'
              style={{width:'100%' ,height:'500px',backgroundColor:'gray'}} >
                <video  src={demoUrl} controls autoPlay muted={true}
                style={{objectFit:"fill",width:'250px' ,height:'500px'}} />      
            </div>
